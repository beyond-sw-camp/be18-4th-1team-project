...
const Views = {
  list: defineAsyncComponent(() => import("@/components/plans/PlanListTable.vue")),
  create: defineAsyncComponent(() => import("@/components/plans/CreatePlanForm.vue")),
};
