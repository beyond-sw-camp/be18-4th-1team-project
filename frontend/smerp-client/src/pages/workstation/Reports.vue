    ...
    <div class="flex-grow-1 d-flex flex-column">
      ...
      <main class="content container-fluid py-3">
        ...
        <div class="card shadow-sm">
          <div class="card-body">
            <h6 class="fw-bold mb-3">통계 및 조회 메뉴</h6>
            <div class="row g-3 mb-4">
              <div class="col-6 col-md-4">
                <router-link to="/sales/summary" class="ws-box">
                  판매 현황
                </router-link>
              </div>
              <div class="col-6 col-md-4">
              ...
              <div class="col-6 col-md-4">
                <router-link to="/work-orders/status" class="ws-box">
                  생산 현황
                </router-link>
              </div>
              <div class="col-6 col-md-4">
                <router-link to="/orders/summary" class="ws-box">
                  주문 현황
                </router-link>
              </div>
              <div class="col-6 col-md-4">
                <router-link to="/logs" class="ws-box">
                  로그 목록
                </router-link>
              </div>
            </div>
