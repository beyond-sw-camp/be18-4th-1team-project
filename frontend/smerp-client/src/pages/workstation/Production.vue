    ...
    <div class="flex-grow-1 d-flex flex-column">
      ...
      <main class="content container-fluid py-3">
        ...
        <div class="card shadow-sm">
          <div class="card-body">
            <h6 class="fw-bold mb-3">생산관리 메뉴</h6>
            <div class="row g-3 mb-4">
              <div class="col-6 col-md-4">
                <router-link to="/plans" class="ws-box">
                  생산계획
                </router-link>
              </div>
              <div class="col-6 col-md-4">
                <router-link to="/work-orders" class="ws-box">
                  작업지시
                </router-link>
              </div>
              <div class="col-6 col-md-4">
                <router-link to="/production-results" class="ws-box">
                  생산실적조회
                </router-link>
              </div>
              <div class="col-6 col-md-4">
                <router-link to="/lots" class="ws-box">
                  LOT 조회
                </router-link>
              </div>
              <div class="col-6 col-md-4">
              ...
              <div class="col-6 col-md-4">
                <router-link to="/boms/requirements" class="ws-box">
                  소요량 계산
                </router-link>
              </div>
            </div>
