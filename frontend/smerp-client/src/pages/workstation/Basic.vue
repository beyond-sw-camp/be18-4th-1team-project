    ...
    <div class="flex-grow-1 d-flex flex-column">
      ...
      <main class="content container-fluid py-3">
        ...
        <div class="card shadow-sm">
          <div class="card-body">
            <h6 class="fw-bold mb-3">기초관리 메뉴</h6>
            <div class="row g-3 mb-4">
              <div class="col-6 col-md-4">
                <router-link to="/users" class="ws-box">
                  사용자 관리
                </router-link>
              </div>
              <div class="col-6 col-md-4">
                <router-link to="/clients" class="ws-box">
                  거래처 관리
                </router-link>
              </div>
              <div class="col-6 col-md-4">
                <router-link to="/items" class="ws-box">
                  품목 관리
                </router-link>
              </div>
              <div class="col-6 col-md-4">
                <router-link to="/warehouses" class="ws-box">
                  창고 관리
                </router-link>
              </div>
            </div>
