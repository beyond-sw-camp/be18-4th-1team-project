...
|--------------|-----------------------------------------------------------------------------------------------------------------|
|      최정필        |     |
|      박채연        | cicd 라는 개념이 잘 와닿지는 않았었는데 총 과정을 진행해보면서 코드 자동화와 배포라는 작업은 코드 
자체보다 많은 외부 요소에 대한 관리와 개입이 필요함을 알게 되었습니다.
특히 로컬 환경을 활용하는 점에서 db에 대한 구성방법과 같이 고민점들이 있어 흥미로웠고
, 운영체제별 명령어의 차이 등을 생각해 좀 더 완성도있게 보완해보고 싶습니다.             |
|      김민준        |      |
